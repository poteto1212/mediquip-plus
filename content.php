...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
    <div class="listarticle">
        ...
        <div class="entry-summary">
           	<?php the_excerpt(); ?>
            <a class="pagemore" href="<?php the_permalink(); ?>"><?php esc_html_e('Read More','mediquip-plus'); ?></a>
        </div>
        <?php else : ?>
        <div class="entry-content">
            <?php the_content( __( 'Continue reading <span class="meta-nav">&rarr;</span>', 'mediquip-plus' ) ); ?>
            <?php
                wp_link_pages( array(
